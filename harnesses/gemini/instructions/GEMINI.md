...
**IMPORTANT:** Run Gemini from the project root (`~/Projects/ai-coding-bake-off/`), NOT from the harness directory. All paths below are relative to the project root.
...
4. Build your solution in: `harnesses/gemini/output/level-{N}/`
5. Run the provided test suite: `pytest challenges/level-{N}-*/test_suite/ -v`
6. Write additional tests in your solution
7. Record timing in: `harnesses/gemini/output/level-{N}/metadata.json`
...
| Your output | `harnesses/gemini/output/level-{N}/` |
| Your metadata | `harnesses/gemini/output/level-{N}/metadata.json` |
...
Record in `harnesses/gemini/output/level-{N}/metadata.json` after each level:
