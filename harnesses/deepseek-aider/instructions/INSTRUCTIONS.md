...
4. Build your solution in: `harnesses/deepseek-aider/output/level-{N}/`
5. Run the provided test suite: `pytest challenges/level-{N}-*/test_suite/ -v`
6. Write additional tests in your solution
7. Record timing in: `harnesses/deepseek-aider/output/level-{N}/metadata.json`
...
| Your output | `harnesses/deepseek-aider/output/level-{N}/` |
| Your metadata | `harnesses/deepseek-aider/output/level-{N}/metadata.json` |
...
Record in `harnesses/deepseek-aider/output/level-{N}/metadata.json` after each level:
